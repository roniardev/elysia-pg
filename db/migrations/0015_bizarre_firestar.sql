...
ALTER TABLE "user_permissions" ADD COLUMN "id" varchar(26) NOT NULL;--> statement-breakpoint
ALTER TABLE "scope_user_permissions" DROP CONSTRAINT "scope_user_permissions_scope_id_user_permission_id_pk";--> statement-breakpoint
ALTER TABLE "scope_user_permissions" ADD COLUMN "id" varchar(26) NOT NULL;--> statement-breakpoint
ALTER TABLE "user_permissions" ADD CONSTRAINT "user_permissions_pkey" PRIMARY KEY("id");--> statement-breakpoint
ALTER TABLE "scope_user_permissions" ADD CONSTRAINT "scope_user_permissions_pkey" PRIMARY KEY("id");--> statement-breakpoint
