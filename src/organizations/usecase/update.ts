...
import { updateOrganizationModel } from "../data/organizations.model"

export const updateOrganization = new Elysia()
	.use(updateOrganizationModel)
	.use(jwtAccessSetup)
	.use(bearer())
	.put(
		"/organization/:id",
		async ({ params, body, bearer, set, jwtAccess }) => {
			const path = "organizations.update.usecase"
